...
function AboutPlace({ onSaveAndExit, onNext, onBack, isSaving, hostId, progress, setProgress }) {
    ...
    useEffect(() => {
        const t = setTimeout(() => setProgress(6), 50);
    ...
    return (
        <>
            <div className="min-h-screen bg-white">
                ...
                <div className={`flex items-stretch min-h-[calc(100vh-160px)] px-8 transition-all duration-700 ease-out ${revealed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`}>
                    <div className="w-[40%] flex items-center ml-32">
                        <div className="max-w-2xl">
                            <div className="text-lg text-gray-800 font-semibold mb-2">Step 1</div>
                            <h1 className="text-[2.8rem] font-semibold text-gray-900 leading-tight mb-4">
                    ...
                    <div className="w-[45%] flex items-center justify-center">
                        <div className="w-[520px] max-w-full rounded-2xl overflow-hidden ">
                            <video
                ...
                <div className="h-1 mt-1 w-full bg-gray-300 relative overflow-hidden">
                ...
                <div className="flex items-center justify-between px-8 py-4">
                    ...
                    <button 
                        ...
                        className={`px-8 py-3 bg-black text-white rounded-lg hover:bg-gray-900 transition-colors ${
                            isSaving ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-900'
                        }`}
                    >
